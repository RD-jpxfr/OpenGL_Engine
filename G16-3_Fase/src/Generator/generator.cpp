...
void coordenadasPatch(int tess, vector<Patch> patches, ofstream& file) {
    ...
    cout << patches.at(30).points[15].p[0] << "," << patches.at(30).points[15].p[2] << endl;
    ...
    for (vector<Patch>::const_iterator i = patches.begin(); i != patches.end(); i++) {
        for (int vaux = 0; vaux < tess; vaux++) {
            ...
            for (int uaux = 0; uaux < tess; uaux++) {
                ...
                // 1st triangle
                getBezierPoint(u0, v0, (*i).points, pos);
                file << pos[0] << " " << pos[1] << " " << pos[2] << endl; // 1st point
                getBezierPoint(u0, v1, (*i).points, pos);
                file << pos[0] << " " << pos[1] << " " << pos[2] << endl; // 2nd point
                getBezierPoint(u1, v0, (*i).points, pos);
                file << pos[0] << " " << pos[1] << " " << pos[2] << endl; // 3rd point
                ...
                getBezierPoint(u0, v1, (*i).points, pos);
                file << pos[0] << " " << pos[1] << " " << pos[2] << endl; // 2nd point
                getBezierPoint(u1, v1, (*i).points, pos);
                file << pos[0] << " " << pos[1] << " " << pos[2] << endl; // 3rd point
            }
        }
    }
